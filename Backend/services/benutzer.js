...
serviceRouter.put('/benutzer', function(request, response) {
    ...
    const benutzerDao = new BenutzerDao(request.app.locals.dbConnection);
    try {
        var result = benutzerDao.update(request.body.id, request.body.vorname, request.body.nachname, request.body.benutzername, request.body.email, request.body.strasse, request.body.hausnummer,  request.body.plz, request.body.ort, request.body.passwort, request.body.wallet);
