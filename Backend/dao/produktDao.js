...
class ProduktDao {
    ...
    create(Titel ="", Autor="", ISBN="", Zustand="", Kategorie="", Preis="", BenutzerID="") {
       // const produktbildDao = new ProduktbildDao(this._conn);

        var sql = 'INSERT INTO Produkt (Titel,Autor,Kategorie,Zustand,ISBN,Preis, BenutzerID) VALUES (?,?,?,?,?,?,?)';
        var statement = this._conn.prepare(sql);
        var params = [Titel, Autor,  Kategorie, Zustand, ISBN,  Preis, BenutzerID];
